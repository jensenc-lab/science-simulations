...
(function () {
  ...
  function updateButton(button) {
    ...
    button.setAttribute('aria-label', inFS ? 'Salir de pantalla completa' : 'Entrar a pantalla completa');
    button.setAttribute('title', inFS ? 'Salir de pantalla completa' : 'Entrar a pantalla completa');
