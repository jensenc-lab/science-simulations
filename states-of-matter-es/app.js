// Estados de la Materia: Laboratorio de Partículas — Utah SEEd 6.2.2
'use strict';
...
function drawFrame(){
  ...
  const cfg=T.stateCfg[state]||T.stateCfg.solid;
...
// ── Actualización de UI ───────────────────────────────────────────────────────
function updateUI(){
  const s=sub, cfg=T.stateCfg[state]||T.stateCfg.solid;
