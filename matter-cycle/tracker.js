...
const STOPS = [
  ...
  {step:1, x: 94, y:260, cpx:130, cpy: 55, msg:{en:'The cactus takes in matter from air and water to grow!',                           es:'¡El cactus toma materia del aire y agua para crecer!'}},
  {step:2, x:287, y:268, cpx:200, cpy:195, msg:{en:'The rat eats the cactus — matter moves to the rat!',                               es:'¡La rata come el cactus — la materia pasa a la rata!'},         breath:true},
  {step:3, x:385, y:275, cpx:325, cpy:210, msg:{en:'The snake eats the rat — matter moves to the snake!',                              es:'¡La serpiente come la rata — la materia pasa a la serpiente!'},breath:true},
  {step:4, x:165, y:276, cpx:265, cpy:318, msg:{en:'The snake dies — but the matter is still here!',                                   es:'¡La serpiente muere — pero la materia sigue aquí!'}},
  {step:5, x:228, y:318, cpx:210, cpy:293, msg:{en:'Decomposers break down the dead matter!',                                          es:'¡Los descomponedores descomponen la materia muerta!'},          decompose:true},
