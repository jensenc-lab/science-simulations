...
const T = {
  en:{
    ...
    langBtn:'🇪🇸 Español', followPlay:'▶ Follow the Matter!',
    ...
    stepInfo:[
      {name:'🌍 The Environment',      role:'Where matter begins — and ends up again!',  gets:'Matter is always here: in the air, water, and soil.',              passes:'Plants pull matter from the air and water from the soil to grow.',         desc:'Matter is all around us — in the air, water, and soil. Plants use matter from the air and water from the soil to grow. This is where the cycle begins... and where it ends up again!'},
      {name:'🌵 Producers',            role:'They make their own food!',                  gets:'Air + water + sunlight',                                           passes:'Animals eat them; when they die, decomposers break them down.',           desc:'Desert plants like cactus and sagebrush take in matter from the air and water from the soil. They use energy from the Sun to turn this matter into plant material — leaves, stems, roots, and fruit. They MAKE their own food!'},
      {name:'🐁 Kangaroo Rat',         role:'Primary Consumer',                           gets:'Eats seeds and plant parts',                                       passes:'Matter moves to the snake when eaten; some is breathed back into the air.',desc:'The kangaroo rat eats seeds and parts of desert plants. When it eats, the matter that was in the plant becomes part of the rat\'s body. The rat also breathes out some matter back into the air.'},
      {name:'🐍 Rattlesnake & 🦅 Hawk',role:'Secondary Consumers',                      gets:'Eats kangaroo rats and other small animals',                       passes:'Matter moves on when they are eaten or when they die.',                   desc:'The rattlesnake eats the kangaroo rat. The matter that was in the rat now becomes part of the snake\'s body. The snake also breathes out some matter into the air.'},
      {name:'🍂 Dead Matter',          role:'Matter waiting to be recycled!',             gets:'The remains of dead plants and animals',                           passes:'Decomposers break it all down.',                                          desc:'When plants and animals die, their bodies still contain matter. Leaves fall, animals die — but the matter doesn\'t disappear! It\'s still there, waiting to be recycled.'},
      {name:'🍄 Decomposers',          role:'Nature\'s recyclers!',                       gets:'Dead plants and animals',                                          passes:'Matter released back to air and soil — the cycle starts again!',          desc:'Tiny organisms like bacteria and fungi break down dead plants and animals. They use some of the matter for their own bodies, and they release the rest back into the air and soil. Decomposers are nature\'s recyclers — they complete the cycle!'},
    ],
  ...
  es:{
    ...
    langBtn:'🇺🇸 English', followPlay:'▶ ¡Sigue la Materia!',
    ...
    stepInfo:[
      {name:'🌍 El Medio Ambiente',      role:'¡Donde comienza y termina la materia!',   gets:'La materia siempre está aquí: en el aire, el agua y el suelo.',  passes:'Las plantas absorben materia del aire y el agua del suelo para crecer.',   desc:'La materia está a nuestro alrededor — en el aire, el agua y el suelo. Las plantas usan materia del aire y agua del suelo para crecer. ¡Aquí comienza el ciclo... y aquí termina de nuevo!'},
      {name:'🌵 Productores',            role:'¡Hacen su propio alimento!',               gets:'Aire + agua + luz solar',                                         passes:'Los animales los comen; cuando mueren, los descomponedores los descomponen.',desc:'Las plantas del desierto como el cactus y la artemisa absorben materia del aire y agua del suelo. Usan la energía del Sol para convertir esta materia en material vegetal. ¡HACEN su propio alimento!'},
      {name:'🐁 Rata Canguro',           role:'Consumidor Primario',                      gets:'Come semillas y partes de plantas',                               passes:'La materia pasa a la serpiente cuando es comida; algo se exhala al aire.',  desc:'La rata canguro come semillas y partes de plantas del desierto. Cuando come, la materia de la planta pasa a ser parte del cuerpo de la rata. La rata también exhala materia de vuelta al aire.'},
      {name:'🐍 Serpiente & 🦅 Halcón', role:'Consumidores Secundarios',                 gets:'Come ratas canguro y otros animales pequeños',                    passes:'La materia continúa cuando son comidos o mueren.',                        desc:'La serpiente de cascabel come la rata canguro. La materia que estaba en la rata ahora forma parte del cuerpo de la serpiente. La serpiente también exhala materia al aire.'},
      {name:'🍂 Materia Muerta',         role:'¡Materia esperando ser reciclada!',        gets:'Los restos de plantas y animales muertos',                        passes:'Los descomponedores lo descomponen todo.',                                desc:'Cuando las plantas y los animales mueren, sus cuerpos todavía contienen materia. Las hojas caen, los animales mueren — ¡pero la materia no desaparece! Sigue ahí, esperando ser reciclada.'},
      {name:'🍄 Descomponedores',        role:'¡Los recicladores de la naturaleza!',      gets:'Plantas y animales muertos',                                      passes:'¡Materia liberada al aire y al suelo — el ciclo comienza de nuevo!',      desc:'Organismos diminutos como bacterias y hongos descomponen plantas y animales muertos. Usan algo de esa materia para sus propios cuerpos y liberan el resto al aire y al suelo. ¡Los descomponedores completan el ciclo!'},
    ],
